...
CREATE TABLE IF NOT EXISTS `floreria`.`detallesdeventa` (
  ...
  `ventascabeceraid` INT NOT NULL,
  `productoid` INT NOT NULL,
  `cantidadvendida` INT NOT NULL,
  `unidad` VARCHAR(255) NOT NULL,
  `monto` DECIMAL(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_detallesdeventa_productos1_idx` (`productoid` ASC) VISIBLE,
  INDEX `fk_detallesdeventa_ventascabecera1_idx` (`ventascabeceraid` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 18
